...
RSpec.describe 'V1::Houses', type: :request do
  ...
  describe 'POST /v1/houses' do
    it 'creates a house if user is logged in' do
      post '/v1/houses',
           params: { house: { address: '123 Main St', city: 'Denver',
                              state: 'CO', zip: '80211', price: '100000', bedrooms: '3', bathrooms: '2',
                              description: 'This is a great house', user_id: @user.id } },
  ...
  describe 'PUT /v1/houses/:id' do
    it 'updates a house if user is logged in' do
      put '/v1/houses/1',
          params: { house: { address: '123 Main St', city: 'Denver',
                             state: 'CO', zip: '80211', price: '100000', bedrooms: '3',
                             bathrooms: '2', description: 'This is a great house', user_id: @user.id } },
          headers: { Authorization: @authorization }
      expect(response).to have_http_status(:ok)
    end
  end
